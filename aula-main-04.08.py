...
class ConfiguraTela:
    ...
    def tela_contagem_votos(self): #Método de contagem e 'get' dos votos e do vencedor 
        self.janela_principal = Frame(self.root, bg = 'white') # Frame que cobra toda à tela 
        self.janela_principal.place(relx = 0, rely = 0, relwidth = 1, relheight = 1)

        self.titulo1_txt = Label(self.root,      
                                text='Levantamento dos Votos:',
                                font=('Arial', 35),
                                bg='white',
                                fg='black')
        self.titulo1_txt.place(relx=0.02, rely=0.05)
